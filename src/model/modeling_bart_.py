...
def _expand_mask_(mask: torch.Tensor, dtype: torch.dtype, tgt_len: Optional[int] = None):
    """
    Expands attention_mask from `[bsz, seq_len]` to `[bsz, 1, tgt_seq_len, src_seq_len]`.
    """
    bsz, src_len = mask.size()
...
class BartDecoder(BartPretrainedModel):
    ...
    def _prepare_decoder_attention_mask(self, attention_mask, input_shape, inputs_embeds, past_key_values_length):
        ...
        if attention_mask is not None:
            # [bsz, seq_len] -> [bsz, 1, tgt_seq_len, src_seq_len]
            # Changed _expand_mask to _expand_mask_ for attention_mask 
            expanded_attn_mask = _expand_mask_(attention_mask, inputs_embeds.dtype, tgt_len=input_shape[-1]).to(
...
class BartForConditionalGeneration(BartPretrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            # print(input_ids.shape, labels.shape, lm_logits.shape, decoder_input_ids.shape)
